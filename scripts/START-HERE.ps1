...
Write-Host "  1) This runs a TUNE scan (liquidity sort, shortlist by APR, no Jupiter hangs)" -ForegroundColor White
Write-Host "     For stricter high-APR hunt: .\scripts\run_hyper_apr_scan.ps1" -ForegroundColor DarkGray
