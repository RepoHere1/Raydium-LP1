...
def build_dashboard(
    *,
    ...
    settings = {
        ...
        "momentum_hot_min_combined_score": getattr(config, "momentum_hot_min_combined_score", 72.0),
        "momentum_hot_min_apr": getattr(config, "momentum_hot_min_apr", 200.0),
        "sort_candidates_by_momentum": getattr(config, "sort_candidates_by_momentum", True),
        "lp_selection_mode": getattr(config, "lp_selection_mode", "apr"),
    ...
    last_scan = {
        ...
        "candidate_count_executable": report.get("candidate_count_executable"),
