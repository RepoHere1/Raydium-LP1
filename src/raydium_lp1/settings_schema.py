...
KNOWN_SETTINGS_KEYS: tuple[str, ...] = (
    ...
    "emergency_route_watch_enabled",
    "emergency_route_checks_per_day",
    ...
    "super_brainiac_page_size",
    "super_brainiac_pool_sort_field",
    "super_brainiac_sort_type",
    "super_brainiac_prefer_new_pools",
    "super_brainiac_max_pool_age_hours",
    "super_brainiac_min_pool_age_hours",
    "super_brainiac_prefer_fee_pct_min",
    "super_brainiac_prefer_fee_pct_max",
    "super_brainiac_require_buy_route",
    "super_brainiac_require_sell_route",
    "super_brainiac_max_route_price_impact_pct",
    "super_brainiac_min_score_to_open",
